 ...
 * limitations under the License.
 * =============================================================================
 */const Ta=20,Ht=3,Ts=7;function Wf(t,e,n,s){const r=jt(e),a=Mf(t,e,n,r),o=e.length,i=Dn(t,e,n,r,a),u=["Tensor"];return s&&(u.push(`  dtype: ${n}`),u.push(`  rank: ${o}`),u.push(`  shape: [${e}]`),u.push("  values:")),u.push(i.map(c=>"    "+c).join(`
`)),u.join(`
 ...
 * limitations under the License.
 * =============================================================================
 */dc();const tm={buffer:Pe,cast:J,clone:Ge,print:Sr};Uf(tm);/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function By(t,e,n,s,r,a,o){r==null&&(r=[1,1]),a==null&&(a=1),s===0&&(s="valid");const i=d(t,"x","maxPool");let u=i,c=!1;i.rank===3&&(c=!0,u=I(i,[1,i.shape[0],i.shape[1],i.shape[2]])),g(Xe(a,r),()=>`Error in pool: Either strides or dilations must be 1. Got strides ${a} and dilations '${r}'`);const h=Mc(u.shape,e,a,r,s),l=[h.dilationHeight,h.dilationWidth];let f;s==="same"?f=zy([h.filterHeight,h.filterWidth],l):f=[[0,0],[0,0]];const m=l[0]===1&&l[1]===1,[b,T]=Py([h.inHeight,h.inWidth],l,f),S=m?s:"valid",$=m?u:Ur(u,l,b),v=(n==="avg"?()=>Er($,e,a,S,o):()=>Wr($,e,a,S,o))(),_=m?v:kr(v,l,T);return c?I(_,[_.shape[1],_.shape[2],_.shape[3]]):_}function Py(t,e,n){const s=n.map(h=>h[0]),r=n.map(h=>h[1]),a=t.concat(s,r),o=e.map((h,l)=>(h-a[l]%h)%h),i=r.map((h,l)=>h+o[l]),u=e.map((h,l)=>[s[l],i[l]]),c=e.map((h,l)=>[0,o[l]]);return[u,c]}function zy(t,e){const s=t.map((o,i)=>o+(o-1)*(e[i]-1)).map(o=>o-1),r=s.map(o=>Math.floor(o/2)),a=s.map((o,i)=>o-r[i]);return s.map((o,i)=>[r[i],a[i]])}const Zl=w({pool_:By});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function jb(t){const n={x:d(t,"x","sinh")};return N.runKernel(ku,n)}const bh=w({sinh_:jb});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function T0(t,e,n,s){const r=d(t,"x","dropout");if(g(r.dtype==="float32",()=>`x has to be a floating point tensor since it's going to be scaled, but got a ${r.dtype} tensor instead.`),g(e>=0&&e<1,()=>`rate must be a float in the range [0, 1), but got ${e}.`),e===0)return t instanceof ne?r.clone():r;const a=S0(r,n),o=1-e,i=Z(Dr(B(cs(a,0,1,"float32",s),o)),o);return D(r,i)}const jh=w({dropout_:T0});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function R0({a:t,b:e,transposeA:n=!1,transposeB:s=!1,bias:r,activation:a="linear",preluActivationWeights:o,leakyreluAlpha:i=.2}){if(bs(N.state.gradientDepth,a)===!1){let y=U(t,e,n,s);return r!=null&&(y=B(y,r)),ys(y,a,o,i)}let u=d(t,"a","fused matMul"),c=d(e,"b","fused matMul");[u,c]=ee(u,c);const h=n?u.shape[u.rank-2]:u.shape[u.rank-1],l=s?c.shape[c.rank-1]:c.shape[c.rank-2],f=n?u.shape[u.rank-1]:u.shape[u.rank-2],m=s?c.shape[c.rank-2]:c.shape[c.rank-1],b=u.shape.slice(0,-2),T=c.shape.slice(0,-2),S=G(b),$=G(T);g(h===l,()=>`Error in fused matMul: inner shapes (${h}) and (${l}) of Tensors with shapes ${u.shape} and ${c.shape} and transposeA=${n} and transposeB=${s} must match.`);const v=re(u.shape.slice(0,-2),c.shape.slice(0,-2)).concat([f,m]),_=n?I(u,[S,h,f]):I(u,[S,f,h]),A=s?I(c,[$,m,l]):I(c,[$,l,m]);let F;r!=null&&(F=d(r,"bias","fused matMul"),[F]=ee(F,u),re(v,F.shape));let L;o!=null&&(L=d(o,"prelu weights","fused matMul"));const R=(y,x)=>{const[C,z,V,j]=x,Y=ms(I(y,V.shape),V,a);let ae,te;if(!n&&!s?(ae=U(Y,z,!1,!0),te=U(C,Y,!0,!1)):!n&&s?(ae=U(Y,z,!1,!1),te=U(Y,C,!0,!1)):n&&!s?(ae=U(z,Y,!1,!0),te=U(C,Y,!1,!1)):(ae=U(z,Y,!0,!0),te=U(Y,C,!0,!0)),r!=null){const se=gs(j,Y);return[ae,te,se]}else return[ae,te]},k={a:_,b:A,bias:F,preluActivationWeights:L},E={transposeA:n,transposeB:s,activation:a,leakyreluAlpha:i};return r==null?Ve((x,C,z)=>{const V=N.runKernel(As,k,E);return z([x,C,V]),{value:I(V,v),gradFunc:R}})(_,A):Ve((x,C,z,V)=>{const j=N.runKernel(As,k,E);return V([x,C,j,z]),{value:I(j,v),gradFunc:R}})(_,A,F)}const C0=w({fusedMatMul_:R0});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Mw(t,e,n,s=de.SUM_BY_NONZERO_WEIGHTS){const r=d(t,"labels","meanSquaredError"),a=d(e,"predictions","meanSquaredError");let o=null;n!=null&&(o=d(n,"weights","meanSquaredError")),ge(r.shape,a.shape,"Error in meanSquaredError: ");const i=ea(r,a);return Ze(i,o,s)}const jw=w({meanSquaredError_:Mw});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class ua extends ht{static get className(){return"Adagrad"}constructor(e,n=.1){super(),this.learningRate=e,this.initialAccumulatorValue=n,this.accumulatedGrads=[]}applyGradients(e){(Array.isArray(e)?e.map(s=>s.name):Object.keys(e)).forEach((s,r)=>{const a=N.registeredVariables[s];this.accumulatedGrads[r]==null&&(this.accumulatedGrads[r]={originalName:`${s}/accumulator`,variable:q(()=>Ut(a.shape,this.initialAccumulatorValue).variable(!1))});const o=Array.isArray(e)?e[r].tensor:e[s];if(o==null)return;const i=this.accumulatedGrads[r].variable;q(()=>{const u=B(i,Ie(o));i.assign(u);const c=B(D(Z(o,ze(B(u,N.backend.epsilon()))),-this.learningRate),a);a.assign(c)})}),this.incrementIterations()}dispose(){this.accumulatedGrads!=null&&me(this.accumulatedGrads.map(e=>e.variable))}async getWeights(){return[await this.saveIterations()].concat(this.accumulatedGrads.map(e=>({name:e.originalName,tensor:e.variable})))}async setWeights(e){e=await this.extractIterations(e);const n=!1;this.accumulatedGrads=e.map(s=>({originalName:s.name,variable:s.tensor.variable(n)}))}getConfig(){return{learningRate:this.learningRate,initialAccumulatorValue:this.initialAccumulatorValue}}static fromConfig(e,n){return new e(n.learningRate,n.initialAccumulatorValue)}}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
